...
def parse_arguments():
    ...
    parser.add_argument("--batch-size", type=int, default=96, help="Batch size for training")
    parser.add_argument("--epochs", type=int, default=401, help="Number of epochs for training")
    ...
    parser.add_argument("--timesteps", type=int, default=1000, help="Timesteps T for DDPM training")
    ...
    parser.add_argument("--noise-schedule", type=str, default="cosine", choices=["linear", "cosine"], help="Noise schedule for DDPM training")
