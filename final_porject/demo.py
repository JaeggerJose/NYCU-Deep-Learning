...
parser.add_argument("-gs", "--gradient_steps", type=int,default=1000, help="number of gradient steps for the adaptation")
...
with open('./demo/count.txt', 'w') as f:
    f.write('{:6.2f}'.format(output.sum().item()))

# python demo.py --input-image ./demo/demo.jpg --bbox-file ./demo/box.txt  --output-dir ./demo